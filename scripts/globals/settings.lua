...
SHOP_PRICE = 3.000; -- Multiplies prices in NPC shops.
...
SPELL_POWER = 3.000; -- Multiplies damage dealt by Elemental and Divine Magic.
BLUE_POWER  = 3.000; -- Multiplies damage dealt by most Blue Magic.
...
ENHANCING_SONG_DURATION = 960; -- duration of enhancing bard songs such as Minuets, Ballads, etc.
STONESKIN_CAP = 350; -- soft cap for hp absorbed by stoneskin
BLINK_SHADOWS = 3;   -- number of shadows supplied by Blink spell
ENSPELL_DURATION = 720; -- duration of RDM en-spells
SPIKE_EFFECT_DURATION = 720; -- the duration of RDM, BLM spikes effects (not Reprisal)
ELEMENTAL_DEBUFF_DURATION = 120; -- base duration of elemental debuffs
STORM_DURATION = 720; -- duration of Scholar storm spells
...
SNEAK_INVIS_DURATION_MULTIPLIER = 5; -- multiplies duration of sneak,invis,deodorize to reduce player torture. 1 = retail behavior. MUST BE INTEGER.
